...
styles = [
    "Renaissance", "Baroque", "Rococo", "Neoclassicism", "Romanticism", "Realism", "Surrealism", "Impressionism",
    "Post-Impressionism", "Modernism", "Post-Modernism"
]
...
def report_image(prompt, generate_image_by_sd_file_path, judge_image_by_gemini):
    ...
    files = {'photo': (
        os.path.basename(generate_image_by_sd_file_path), open(generate_image_by_sd_file_path, 'rb'), 'image/png')}
    data = {
...
def generate_random_prompt():
    ...
    data = {
        "contents": [{"parts": [{
            "text": "Please imagine a scene suitable for a photo or drawing and describe it in no more than 50 words. Thank you."}]}]
    }
